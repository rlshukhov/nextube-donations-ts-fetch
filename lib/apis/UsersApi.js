...
class UsersApi extends runtime.BaseAPI {
    ...
    usersEmailConfirmationResendRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.UsersEmailConfirmationResend200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    ...
    /**
     */
    usersEmailPasswordResetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['usersEmailPasswordResetRequest'] == null) {
                throw new runtime.RequiredError('usersEmailPasswordResetRequest', 'Required parameter "usersEmailPasswordResetRequest" was null or undefined when calling usersEmailPasswordReset().');
            }
            const queryParameters = {};
            const headerParameters = {};
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.UsersEmailPasswordResetRequestToJSON)(requestParameters['usersEmailPasswordResetRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.UsersEmailConfirmationResend200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    usersEmailPasswordReset(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.usersEmailPasswordResetRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    usersEmailPasswordResetUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['usersEmailPasswordResetUpdateRequest'] == null) {
                throw new runtime.RequiredError('usersEmailPasswordResetUpdateRequest', 'Required parameter "usersEmailPasswordResetUpdateRequest" was null or undefined when calling usersEmailPasswordResetUpdate().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.UsersEmailPasswordResetUpdateRequestToJSON)(requestParameters['usersEmailPasswordResetUpdateRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.UsersEmailConfirmationResend200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    usersEmailPasswordResetUpdate(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.usersEmailPasswordResetUpdateRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    usersLoginRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['usersRegisterRequest'] == null) {
                throw new runtime.RequiredError('usersRegisterRequest', 'Required parameter "usersRegisterRequest" was null or undefined when calling usersLogin().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
