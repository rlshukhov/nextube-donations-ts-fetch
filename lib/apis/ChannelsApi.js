...
class ChannelsApi extends runtime.BaseAPI {
    ...
    /**
     */
    channelsUpdateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['channelsUpdateRequest'] == null) {
                throw new runtime.RequiredError('channelsUpdateRequest', 'Required parameter "channelsUpdateRequest" was null or undefined when calling channelsUpdate().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ChannelsUpdateRequestToJSON)(requestParameters['channelsUpdateRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ChannelsCreate200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    channelsUpdate(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.channelsUpdateRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
